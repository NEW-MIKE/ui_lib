...
public class PolyToPolySample6View extends LinearLayout {
    ...
    public PolyToPolySample6View(Context context) {
        super(context);
        init();
    }


    public PolyToPolySample6View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PolyToPolySample6View(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
