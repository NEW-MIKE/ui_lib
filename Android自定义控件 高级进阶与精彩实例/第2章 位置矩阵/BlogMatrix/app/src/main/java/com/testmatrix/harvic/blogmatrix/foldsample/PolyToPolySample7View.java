...
public class PolyToPolySample7View extends LinearLayout {
    ...
    public PolyToPolySample7View(Context context) {
        super(context);
        init();
    }


    public PolyToPolySample7View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PolyToPolySample7View(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void updateFold() {
        ...
        float transWidth = mWidth * (1 - mFactor);
