...
public class PolyToPolySample4View extends LinearLayout {
    ...
    public PolyToPolySample4View(Context context) {
        super(context);
        init();
    }


    public PolyToPolySample4View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PolyToPolySample4View(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            dst[5] = isEven ? mHeight + depth  : mHeight;
            dst[6] = foldedItemWidth * i;
//            dst[7] = isEven ? mHeight: mHeight + depth ;
